...
local waitingForCharacterGuid = "86ea0279-9c33-4e35-9709-3b73e277d097";
pcall( function()
...
local success, err = pcall(function()	
	...
	playerConnectSucces, player = pcall(function() return client:PlayerConnect(0, HOST_IP, HOST_PORT, 0, threadSleepTime) end)
	if not playerConnectSucces then
		--Old player connection scheme
		player = game:GetService("Players"):CreateLocalPlayer(0)
		analytics("Created Player")
		client:Connect(HOST_IP, HOST_PORT, 0, threadSleepTime)
	else
		analytics("Created Player")
	end
